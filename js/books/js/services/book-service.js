...
function fetchBooks(str) {
    const API_KEY = `AIzaSyDu-ALdrHRzJ7B50CVl3xQ0hI4oeW0sHWw`
    var url = `https://www.googleapis.com/books/v1/volumes?q=${str}&key=${API_KEY}`
...
function addGoogleBook(googleBook) {
    googleBook = {
        ...
        "listPrice": {
            "amount": utilService.getRandomInt(30, 200),
            "currencyCode": "USD",
            "isOnSale": false
        },
    }
